...
## Настройки формы
Необходимо поставить галочки `Сбор адресов электронной почты`, `Изменять ответы после отправки формы` и выбрать максимальный размер всех заугржаемых файлов. Больше ничего не трогать
